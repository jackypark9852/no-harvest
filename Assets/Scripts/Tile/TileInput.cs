...
public class TileInput : MonoBehaviour
{
    ...
    public Dictionary<EffectType, Color> effectToColorRedGreenColorblind { get; private set; } = new Dictionary<EffectType, Color>
    {
        [EffectType.None] = Color.clear,
        [EffectType.Destroyed] = new Color(1f, 0.4f, 0f, 0.5f),
        [EffectType.Growth] = new Color(0f, 0f, 1f, 0.5f),
        [EffectType.Neutral] = new Color(0.5f, 0.5f, 0.5f, 0.5f),
    };
    ...
    void Update()
    {
        ...
        */
        ...
        if (isBlinking)
        {
            ...
            if (InputManager.Instance.areRedGreenColorblindColorsOn)
            {
                baseColor = effectToColorRedGreenColorblind[effectType];
            }
        ...
        else
        {
            ...
            if (InputManager.Instance.areRedGreenColorblindColorsOn)
            {
                effectSpriteRenderer.color = effectToColorRedGreenColorblind[effectType];
            }
        }
